...
pos1_soltype = __Dropdown(
    value="0:forward", options=["0:forward", "1:backward", "2:combined"],
    description="pos1-soltype",
)
pos1_elmask = 10  # (deg)
pos1_snrmask = 0  # (dBHz)
pos1_dynamics = __Dropdown(value="0:off", options=["0:off", "1:on"],
        description='pos1-dynamics')
pos1_tidecorr = __Dropdown(value="0:off", options=["0:off", "1:on"],
...
pos1_exclsats = ""  # (prn ...)
pos1_navsys = __SelectMultiple(
    value=["1:gps"],
    options=["1:gps", "2:sbas", "4:glo", "8:gal", "16:qzs", "32:comp"],
...
out_solstatic = __Dropdown(
    value="1:single", options=["0:all", "1:single"], description="out-solstatic"
)
out_nmeaintv1 = 0  # (s)
out_nmeaintv2 = 0  # (s)
out_outstat = __Dropdown(
    value="0:off", options=["0:off", "1:state", "2:residual"], description="out-outstat"
)
stats_errratio = 100
...
stats_stdtrop = 0.3  # (m)
stats_prnaccelh = 1  # (m/s^2)
stats_prnaccelv = 0.1  # (m/s^2)
